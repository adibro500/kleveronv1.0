...
=======
import { Component, OnDestroy, OnInit, TemplateRef, AfterViewInit, DoCheck, AfterContentInit, ElementRef, OnChanges, Input } from '@angular/core';
import { FormsModule } from '@angular/forms';
import { TranslateService } from '@ngx-translate/core';
import { Observable } from "rxjs/Rx";
import { Router } from "@angular/router";
...
export class CreatePageMenuComponent implements OnInit, AfterViewInit, DoCheck, OnChanges {
    ...
    containers = new Array<Container>();
    constructor(private elRef: ElementRef, private containerService: CssClassForDivsService, translate: TranslateService, private router: Router, private modalRef: BsModalRef, private modalService: BsModalService) {
